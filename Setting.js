...
global.owner = process.env.OWNER_NUMBER  || '94760789475' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://asanka:#063893B5BF667E39D@cluster0.eet78jt.mongodb.net/" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '17_06_2024_SIGMA_MD_DmFQEjUa_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || 'asankamd',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `asanka`, // ADD YOUR NAME
